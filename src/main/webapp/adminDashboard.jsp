									...
									<form id="form1" class="p-4 border rounded">
										...
										<div class="grid-container">
											...
											<div class="mb-3">
												...
												<input type="experience" id="experience" name="experience" class="form-control" placeholder="Enter the year you started tutoring " required>
											...
											<div class="mb-3">
												...
												<select id="country" name="country" class="form-control" required onchange="updateCountryCode()">
													...
													<option value="Congo (Congo-Brazzaville)" data-code="+242">Congo (Congo-Brazzaville)</option>
									...
									<form id="form2" class="p-4 border rounded">
										...
										<div class="mb-3">
											...
											<div id="syllabusContainer" style="display: none;">
												...
												<label><input type="checkbox" value="Pearson Edexcel" onchange="updateSyllabus()"> Pearson Edexcel</label>
											</div>
									...
									<form id="form3" class="p-4 border rounded" enctype="multipart/form-data">
										...
										<div class="mb-3">
											...
											<input type="hidden" id="hiddenAddress" name="hiddenAddress"
												...
												<input type="hidden" id="hiddenExp" name="hiddenExp" class="form-control">
										</div>
