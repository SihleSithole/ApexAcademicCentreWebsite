...
<div class="wrapper">
	 ...
	 <div id="sidebar">
		...
		<ul class="list-unstyled component m-0">
		  ...
		  <i class="material-icons">aspect_ratio</i>Tutors
		  </a>
          <li class="">
            <a href="#" class=""><i class="material-icons">library_books</i>Bookings </a>
            </li>
				    ...
				    <div class="col-md-12">
					   ...
					   <table class="table table-striped table-hover">
						...
						%>
							 ...
							 <th><%= tutor.getName()%></th>
							 <th><%= tutor.getEmail()%></th>
							 <th><%= tutor.getLocation()%></th>
							 <th><%= tutor.getPhoneNumber()%></th>
							 <th>
